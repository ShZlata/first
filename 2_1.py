...
nat1 = list(map(int, input().rjust(3, '0')))
nat2 = list(map(int, input().rjust(3, '0')))
n0 = str((nat1[0] + nat2[0]) % 10)
n1 = str((nat1[1] + nat2[1]) % 10)
n2 = str((nat1[2] + nat2[2]) % 10)
print((n0 + n1 + n2).lstrip('0'))
...
print(f'{newN.rjust(2, "0")}:{newM.rjust(2, "0")}')
